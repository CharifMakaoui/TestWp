...
namespace {
    ...
    class WhatsapiTool extends \Xaamin\Whatsapi\Facades\Laravel\Registration{
        ...
        public static function setListener($listener){
            \Xaamin\Whatsapi\Tools\MGP25::setListener($listener);
        }
        ...
        public static function setDebug($debug = true){
            return \Xaamin\Whatsapi\Tools\MGP25::setDebug($debug);
        }
         ...
         * @static 
         */
        public static function requestCode($number, $type = 'sms', $carrier = null){
            return \Xaamin\Whatsapi\Tools\MGP25::requestCode($number, $type, $carrier);
        }
         ...
         * @static 
         */
        public static function registerCode($number, $code){
            return \Xaamin\Whatsapi\Tools\MGP25::registerCode($number, $code);
        }
